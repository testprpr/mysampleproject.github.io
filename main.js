...
function AlertComponent_div_0_div_2_Template(rf, ctx) { if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function AlertComponent_div_0_div_2_Template_a_click_1_listener() { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r4); const alert_r2 = ctx.$implicit; const ctx_r3 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](2); return ctx_r3.removeAlert(alert_r2); });
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵclassMap"](ctx_r1.cssClasses(alert_r2));
...
function AlertComponent_div_0_Template(rf, ctx) { if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtemplate"](2, AlertComponent_div_0_div_2_Template, 4, 4, "div", 3);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
} if (rf & 2) {
...
AlertComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: AlertComponent, selectors: [["alert"]], inputs: { id: "id", fade: "fade" }, decls: 1, vars: 1, consts: [["class", "container", 4, "ngIf"], [1, "container"], [1, "m-3"], [3, "class", 4, "ngFor", "ngForOf"], [1, "close", 3, "click"], [3, "innerHTML"]], template: function AlertComponent_Template(rf, ctx) { if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtemplate"](0, AlertComponent_div_0_Template, 3, 1, "div", 0);
    } if (rf & 2) {
...
class FakeBackendInterceptor {
    ...
    intercept(request, next) {
        ...
        function authenticate() {
            ...
            return ok(Object.assign(Object.assign({}, basicDetails(account)), { jwtToken: generateJwtToken(account) }));
        }
        ...
        function register() {
            ...
            if (account.id === 1) {
                ...
                account.role = _app_models__WEBPACK_IMPORTED_MODULE_4__["Role"].Admin;
            }
            else {
                account.role = _app_models__WEBPACK_IMPORTED_MODULE_4__["Role"].User;
            }
        ...
        function validateResetToken() {
            const { token } = body;
            const account = accounts.find(x => !!x.resetToken && x.resetToken === token &&
        ...
        function getAccountById() {
            ...
            if (account.id !== currentAccount().id && !isAuthorized(_app_models__WEBPACK_IMPORTED_MODULE_4__["Role"].Admin)) {
                return unauthorized();
            }
            return ok(basicDetails(account));
        }
        function createAccount() {
            if (!isAuthorized(_app_models__WEBPACK_IMPORTED_MODULE_4__["Role"].Admin))
                return unauthorized();
            const account = body;
            if (accounts.find(x => x.email === account.email)) {
...
FakeBackendInterceptor.ɵfac = function FakeBackendInterceptor_Factory(t) { return new (t || FakeBackendInterceptor)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](_app_services__WEBPACK_IMPORTED_MODULE_5__["AlertService"])); };
...
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](FakeBackendInterceptor, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Injectable"]
    }], function () { return [{ type: _app_services__WEBPACK_IMPORTED_MODULE_5__["AlertService"] }]; }, null); })();
...
/*!***********************************!*\
  !*** ./src/app/_helpers/index.ts ***!
  \***********************************/
/*! exports provided: appInitializer, AuthGuard, ErrorInterceptor, FakeBackendInterceptor, fakeBackendProvider, JwtInterceptor, MustMatch */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _must_match_validator__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./must-match.validator */ "./src/app/_helpers/must-match.validator.ts");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "MustMatch", function() { return _must_match_validator__WEBPACK_IMPORTED_MODULE_5__["MustMatch"]; });
...
/*!**********************************!*\
  !*** ./src/app/_models/index.ts ***!
  \**********************************/
/*! exports provided: Account, Alert, AlertType, Role */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _account__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./account */ "./src/app/_models/account.ts");
...
/* harmony import */ var _alert__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./alert */ "./src/app/_models/alert.ts");
...
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "AlertType", function() { return _alert__WEBPACK_IMPORTED_MODULE_1__["AlertType"]; });

/* harmony import */ var _role__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./role */ "./src/app/_models/role.ts");
...
const baseUrl = `${_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].apiUrl}/accounts`;
class AccountService {
    ...
    login(email, password) {
        return this.http.post(`${baseUrl}/authenticate`, { email, password }, { withCredentials: true })
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])(account => {
...
const adminModule = () => __webpack_require__.e(/*! import() | admin-admin-module */ "admin-admin-module").then(__webpack_require__.bind(null, /*! ./admin/admin.module */ "./src/app/admin/admin.module.ts")).then(x => x.AdminModule);
...
const routes = [
    ...
    { path: 'admin', loadChildren: adminModule, canActivate: [_helpers__WEBPACK_IMPORTED_MODULE_3__["AuthGuard"]], data: { roles: [_models__WEBPACK_IMPORTED_MODULE_4__["Role"].Admin] } },
...
function AppComponent_nav_1_a_6_Template(rf, ctx) { if (rf & 1) {
...
function AppComponent_nav_1_Template(rf, ctx) { if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtemplate"](6, AppComponent_nav_1_a_6_Template, 2, 0, "a", 7);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](7, "a", 8);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function AppComponent_nav_1_Template_a_click_7_listener() { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r3); const ctx_r2 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](); return ctx_r2.logout(); });
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵproperty"]("ngIf", ctx_r0.account.role === ctx_r0.Role.Admin);
} }
const _c1 = function (a0) { return { "bg-light": a0 }; };
class AppComponent {
    constructor(accountService) {
        this.accountService = accountService;
        this.Role = _models__WEBPACK_IMPORTED_MODULE_1__["Role"];
...
AppComponent.ɵfac = function AppComponent_Factory(t) { return new (t || AppComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_services__WEBPACK_IMPORTED_MODULE_2__["AccountService"])); };
AppComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: AppComponent, selectors: [["app"]], decls: 5, vars: 4, consts: [[1, "app-container", 3, "ngClass"], ["class", "navbar navbar-expand navbar-dark bg-dark", 4, "ngIf"], ["name", "subnav"], [1, "navbar", "navbar-expand", "navbar-dark", "bg-dark"], [1, "navbar-nav"], ["routerLink", "/", "routerLinkActive", "active", 1, "nav-item", "nav-link", 3, "routerLinkActiveOptions"], ["routerLink", "/profile", "routerLinkActive", "active", 1, "nav-item", "nav-link"], ["routerLink", "/admin", "routerLinkActive", "active", "class", "nav-item nav-link", 4, "ngIf"], [1, "nav-item", "nav-link", 3, "click"], ["routerLink", "/admin", "routerLinkActive", "active", 1, "nav-item", "nav-link"]], template: function AppComponent_Template(rf, ctx) { if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div", 0);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtemplate"](1, AppComponent_nav_1_Template, 9, 3, "nav", 1);
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵproperty"]("ngClass", _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵpureFunction1"](2, _c1, ctx.account));
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵadvance"](1);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵproperty"]("ngIf", ctx.account);
    } }, directives: [_angular_common__WEBPACK_IMPORTED_MODULE_3__["NgClass"], _angular_common__WEBPACK_IMPORTED_MODULE_3__["NgIf"], _angular_router__WEBPACK_IMPORTED_MODULE_4__["RouterOutlet"], _components_alert_component__WEBPACK_IMPORTED_MODULE_5__["AlertComponent"], _angular_router__WEBPACK_IMPORTED_MODULE_4__["RouterLinkWithHref"], _angular_router__WEBPACK_IMPORTED_MODULE_4__["RouterLinkActive"]], encapsulation: 2 });
...
AppModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjector"]({ factory: function AppModule_Factory(t) { return new (t || AppModule)(); }, providers: [
        { provide: _angular_core__WEBPACK_IMPORTED_MODULE_0__["APP_INITIALIZER"], useFactory: _helpers__WEBPACK_IMPORTED_MODULE_4__["appInitializer"], multi: true, deps: [_services__WEBPACK_IMPORTED_MODULE_6__["AccountService"]] },
...
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵsetNgModuleScope"](AppModule, { declarations: [_app_component__WEBPACK_IMPORTED_MODULE_7__["AppComponent"],
        ...
        _home__WEBPACK_IMPORTED_MODULE_9__["HomeComponent"]], imports: [_angular_platform_browser__WEBPACK_IMPORTED_MODULE_1__["BrowserModule"],
        _angular_forms__WEBPACK_IMPORTED_MODULE_2__["ReactiveFormsModule"],
        _angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HttpClientModule"],
        _app_routing_module__WEBPACK_IMPORTED_MODULE_5__["AppRoutingModule"]] }); })();
...
HomeComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: HomeComponent, selectors: [["ng-component"]], decls: 52, vars: 1, consts: [[1, "p-4"], [1, "container"], ["id", "demo", "data-ride", "carousel", 1, "carousel", "slide"], [1, "carousel-indicators"], ["data-target", "#demo", "data-slide-to", "0", 1, "active"], ["data-target", "#demo", "data-slide-to", "1"], ["data-target", "#demo", "data-slide-to", "2"], ["data-target", "#demo", "data-slide-to", "3"], ["data-target", "#demo", "data-slide-to", "4"], ["data-target", "#demo", "data-slide-to", "5"], ["data-target", "#demo", "data-slide-to", "6"], ["data-target", "#demo", "data-slide-to", "7"], ["data-target", "#demo", "data-slide-to", "8"], ["data-target", "#demo", "data-slide-to", "9"], ["data-target", "#demo", "data-slide-to", "10"], ["data-target", "#demo", "data-slide-to", "11"], ["data-target", "#demo", "data-slide-to", "12"], [1, "carousel-inner"], [1, "carousel-item", "active"], ["src", "assets/images/1.jpg", 2, "width", "100%"], [1, "carousel-item"], ["src", "assets/images/2.jpg", 2, "width", "100%"], ["src", "assets/images/3.jfif", 2, "width", "100%"], ["src", "assets/images/4.jfif", 2, "width", "100%"], ["src", "assets/images/5.jfif", 2, "width", "100%"], ["src", "assets/images/6.jfif", 2, "width", "100%"], ["src", "assets/images/7.jfif", 2, "width", "100%"], ["src", "assets/images/8.jfif", 2, "width", "100%"], ["src", "assets/images/9.jfif", 2, "width", "100%"], ["src", "assets/images/10.jfif", 2, "width", "100%"], ["src", "assets/images/11.jfif", 2, "width", "100%"], ["src", "assets/images/12.jfif", 2, "width", "100%"], ["href", "#demo", "data-slide", "prev", 1, "carousel-control-prev"], [1, "carousel-control-prev-icon"], ["href", "#demo", "data-slide", "next", 1, "carousel-control-next"], [1, "carousel-control-next-icon"]], template: function HomeComponent_Template(rf, ctx) { if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div", 0);
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](5, "Have a look at my Sample ");
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](6, "strong");
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](7, "Image Gallery");
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelement"](11, "li", 5);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelement"](12, "li", 6);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelement"](13, "li", 7);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelement"](14, "li", 8);
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelement"](49, "span", 33);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵadvance"](3);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtextInterpolate1"]("Hi ", ctx.account.firstName, "!");
    } }, encapsulation: 2 });
...
module.exports = __webpack_require__(/*! E:\my-sample-project\actual project\angular project'\my-sample-project\src\main.ts */"./src/main.ts");
